...
abstract public class AbstractJpaUserServiceTest extends AbstractUserServiceTest {
    ...
    public void testValidation() throws Exception {
        ...
        validateRootCause(() -> service.create(new User(null, "User", "mail@yandex.ru", "password", 9, true, new Date(), Collections.emptySet())), javax.validation.ConstraintViolationException.class);
        validateRootCause(() -> service.create(new User(null, "User", "mail@yandex.ru", "password", 10001, true, new Date(), Collections.emptySet())), javax.validation.ConstraintViolationException.class);
    }
}
